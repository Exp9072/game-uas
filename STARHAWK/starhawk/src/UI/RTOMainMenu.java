...
public class RTOMainMenu extends JPanel {
    ...
    public void showGameOverScreen() {
        ...
        try {
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("./res/audio/CBGDeath_1.wav"));
        ...
        ImageIcon ll = new ImageIcon("./res/sprite/BbitYouDied.png");
        Image BgDeath; 
        BgDeath = ll.getImage(); 
