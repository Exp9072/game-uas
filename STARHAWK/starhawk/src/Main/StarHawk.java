...
public class StarHawk extends JPanel implements ActionListener {
    ...
    public StarHawk() {
        ...
        ImageIcon ii = new ImageIcon("./res/sprite/Bg_Game.png");
        ImageIcon uu = new ImageIcon("./res/sprite/Bg_Left.png");
        ImageIcon jj = new ImageIcon("./res/sprite/Bg_Right.png");
        ...
        try {
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("C:\\Users\\LEGION\\Documents\\Semua File Penting\\Kampus Project VSC\\KampusS3\\UAS\\STARHAWK\\starhawk\\src\\res\\audio\\CPlayerHurt_1.wav"));
